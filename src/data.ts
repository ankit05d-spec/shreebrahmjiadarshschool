import { GalleryItem, NewsEvent, StudentRecord } from './types';
...
export const DEMO_STUDENTS: StudentRecord[] = [
  // Class 1: Nursery / KG (Fee: 3000)
  {
    ...
    height: "105",
    weight: "16",
    address: "Muhammada Barwapatti, Motichak",
    fatherContact: "9450231827",
    alternateContact: "9984135693",
    bloodGroup: "O+",
    adharNumber: "111122223333",
    photoUrl: "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?auto=format&fit=crop&q=80&w=200",
    admissionDate: "2026-04-10",
    academicClass: "Nursery / KG",
    status: "Approved",
    feesTotal: 3000,
    feesPaid: 3000,
    feesRemarks: "Full payment received on time",
    notifications: [
      { id: "not_1", title: "Welcome to School", message: "Welcome Amit! Your admission is verified.", date: "2026-04-10", read: false }
    ]
  },
  {
    id: "DEMO_STU_NUR_2",
    ...
    height: "102",
    weight: "15",
    address: "Siktiya Village, Kushinagar",
    fatherContact: "9984135693",
    alternateContact: "",
    bloodGroup: "B+",
    adharNumber: "222233334444",
    photoUrl: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?auto=format&fit=crop&q=80&w=200",
    admissionDate: "2026-04-12",
    academicClass: "Nursery / KG",
    status: "Approved",
    feesTotal: 3000,
    feesPaid: 1500,
    feesRemarks: "Paying in installments",
    notifications: []
  },
  {
    id: "DEMO_STU_NUR_3",
    studentName: "Ayush Tiwari",
    lastName: "Tiwari",
    fatherName: "Devesh Tiwari",
    motherName: "Meena Tiwari",
    height: "108",
    weight: "17",
    address: "Muhammada, Kushinagar",
    fatherContact: "6393299193",
    alternateContact: "",
    bloodGroup: "A+",
    adharNumber: "333344445555",
    photoUrl: "",
    ...
    feesTotal: 3000,
    feesPaid: 0,
    feesRemarks: "Pending scholarship support",
    notifications: []
  },

  // Class 2: Class I to III (Fee-Term: 4200)
  {
    id: "DEMO_STU_PRI_1",
    studentName: "Rahul Yadav",
    lastName: "Yadav",
    fatherName: "Shailesh Yadav",
    motherName: "Urmila Yadav",
    height: "115",
    weight: "22",
    address: "Siktiya, Motichak",
    fatherContact: "9984135693",
    alternateContact: "",
    bloodGroup: "AB+",
    adharNumber: "444455556666",
    photoUrl: "",
    admissionDate: "2026-04-05",
    academicClass: "Class I to III",
    status: "Approved",
    feesTotal: 4200,
    feesPaid: 4200,
    feesRemarks: "Annual fees paid in full",
    notifications: []
  },
  {
    id: "DEMO_STU_PRI_2",
    ...
    height: "118",
    weight: "20",
    address: "Kushinagar Town",
    fatherContact: "9450231827",
    alternateContact: "",
    bloodGroup: "O+",
    adharNumber: "555566667777",
    photoUrl: "",
  ...
  },
  {
    ...
    motherName: "Gauri Mishra",
    height: "120",
    weight: "24",
    address: "Motichak, Barwapatti",
    fatherContact: "6393299193",
    alternateContact: "",
    bloodGroup: "B-",
    adharNumber: "666677778888",
    photoUrl: "",
    admissionDate: "2026-04-10",
    academicClass: "Class I to III",
    status: "Approved",
    feesTotal: 4200,
    feesPaid: 0,
    feesRemarks: "Deferred request approved",
    notifications: []
  },

  // Class 3: Class IV to V (Fee: 4800)
  {
    id: "DEMO_STU_MID_1",
    studentName: "Pooja Shah",
    lastName: "Shah",
    fatherName: "Kailash Shah",
    motherName: "Sunita Shah",
    height: "135",
    weight: "30",
    address: "Siktiya Bazar, Kushinagar",
    fatherContact: "9450231827",
    alternateContact: "",
    bloodGroup: "A+",
    adharNumber: "777788889999",
    photoUrl: "",
    admissionDate: "2026-04-02",
    academicClass: "Class IV to V",
    status: "Approved",
    feesTotal: 4800,
    feesPaid: 4800,
    feesRemarks: "Fully paid",
    notifications: []
  },
  {
    id: "DEMO_STU_MID_2",
    studentName: "Rohit Prasad",
    lastName: "Prasad",
    fatherName: "Munna Prasad",
    motherName: "Vidya Prasad",
    height: "132",
    weight: "28",
    address: "Barwapatti Village",
    fatherContact: "9984135693",
    alternateContact: "",
    bloodGroup: "AB-",
    adharNumber: "888899990000",
    photoUrl: "",
    ...
    feesTotal: 4800,
    feesPaid: 2500,
    feesRemarks: "Next installment due next month",
    notifications: []
  },
  {
    id: "DEMO_STU_MID_3",
    studentName: "Nikhil Kushwaha",
    lastName: "Kushwaha",
    fatherName: "Vinod Kushwaha",
    motherName: "Asha Kushwaha",
    height: "140",
    weight: "32",
    address: "Muhammada",
    fatherContact: "6393299193",
    ...
    feesTotal: 4800,
    feesPaid: 0,
    feesRemarks: "Awaiting parent payout",
    notifications: []
  },

  // Class 4: Class VI to VIII (Fee: 6000)
  {
    id: "DEMO_STU_HI_1",
    studentName: "Rakesh Patel",
    lastName: "Patel",
    ...
    alternateContact: "",
    bloodGroup: "O-",
    adharNumber: "121234345656",
    photoUrl: "",
    admissionDate: "2026-04-01",
    academicClass: "Class VI to VIII",
    status: "Approved",
    feesTotal: 6000,
    feesPaid: 6000,
    feesRemarks: "Paid in full",
    notifications: []
  },
  {
    id: "DEMO_STU_HI_2",
    studentName: "Jyoti Sharma",
    lastName: "Sharma",
    fatherName: "Hari Sharma",
    motherName: "Shanti Sharma",
    height: "142",
    weight: "35",
    address: "Siktiya Village",
    fatherContact: "9984135693",
    alternateContact: "",
    bloodGroup: "A-",
    adharNumber: "232345456767",
    photoUrl: "",
    ...
    feesTotal: 6000,
    feesPaid: 3000,
    feesRemarks: "Half paid, half pending",
    notifications: []
  },
  {
    id: "DEMO_STU_HI_3",
    ...
    lastName: "Gond",
    fatherName: "Lalji Gond",
    motherName: "Girija Devi",
    height: "152",
    weight: "41",
    address: "Motichak, Kushinagar",
    fatherContact: "6393299193",
    alternateContact: "",
    bloodGroup: "B+",
    adharNumber: "343456567878",
    photoUrl: "",
    admissionDate: "2026-04-05",
    academicClass: "Class VI to VIII",
    status: "Approved",
    feesTotal: 6000,
    feesPaid: 0,
    feesRemarks: "Requested relaxation for farmers",
    notifications: []
  }
];
